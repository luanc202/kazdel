...
type ShortenedUrlUpdate struct {
...
func NewShortenedUrlUpdate(originalUrl string, expiresAt string, description string, password string) *ShortenedUrlUpdate {
	return &ShortenedUrlUpdate{
...
func (s *ShortenedUrlUpdate) Validate() error {
	if s.OriginalUrl == "" {
